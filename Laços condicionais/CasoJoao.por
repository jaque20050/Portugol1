...
programa
{
	...
	funcao inicio()
	{
		real pt,ex=50.0,multa=4.00//P peso do tomate,ex execsso e m multa

		escreva("\nInforma o peso do Tomate:")
		leia(pt)


		se(pt>=50.0)//Caso o peso do tomate passe do valor indicado, sera necessario pagar a multa
		{
			
			escreva("\nVocê vai pagar multa:R$",multa)
		}
		senao
		{
			escreva("\nVocê não paga multa")//Caso não passe do peso informado, não sera multado
		}
